...
public class UserReservationsReportGeneratorService extends AbstractReservationsReport {
    ...
    public boolean canHandle(final ReportRequestDto reportRequest) {
        return Objects.equals(reportRequest.getReportId(), "USER_RESERVATIONS");
    }
}
